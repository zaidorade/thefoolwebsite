...
<?php /* Template Name: Poetry Archive Page */ ?>

<!-- for live site -->
<?php $catquery = new WP_Query( 'cat=1364' ); ?>
...
padding-left: 12px; border-style: solid; border-spacing: 10px; margin-left: auto; margin-right: auto;" rel="bookmark"> Poetry </h2>
