...
<?php /* Template Name: Prose Archive Page */ ?>

<!-- for live site -->
<?php $catquery = new WP_Query( 'cat=1366' ); ?>
...
padding-left: 12px; border-style: solid; border-spacing: 10px; margin-left: auto; margin-right: auto;" rel="bookmark"> Prose </h2>
